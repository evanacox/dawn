...
namespace {
  std::vector<dawn::Type*> fromSpan(std::span<dawn::Type* const> view) noexcept {
...
namespace dawn {
  ...
  Struct::Struct(std::span<dawn::Type* const> fields) noexcept : Type(this), fields_{fromSpan(fields)} {}
